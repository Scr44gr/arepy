...
from typing import Any, Callable, Generic, Iterable, Iterator, Mapping, Sequence, Type, TypeVar, TypeVarTuple, overload
...
def sign_queries(queries_signature: QuerySignature) -> list[tuple[str, Query[Any, Any]]]: ...
