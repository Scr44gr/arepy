...
from sdl2 import (SDL_GL_ACCELERATED_VISUAL, SDL_GL_CONTEXT_FLAGS,
                  ...
                  SDL_HINT_RENDER_DRIVER, SDL_HINT_VIDEO_HIGHDPI_DISABLED,
                  SDL_INIT_EVERYTHING, SDL_WINDOWPOS_CENTERED, SDL_GetError,
                  SDL_GL_CreateContext, SDL_GL_MakeCurrent,
                  SDL_GL_SetAttribute, SDL_GL_SetSwapInterval, SDL_Init,
                  SDL_SetHint)
